...
import { setAgent,getAgentsBySupervisor } from '../redux';

const mapStateToProps = state => ({
    agents: state.agentsData.filtered,    
...
const Agents = ({ classes, agents, getAgentsBySupervisor,setAgent,supervisor}) => {


     React.useEffect(() => {
        getAgentsBySupervisor(supervisor.document_id);
     }, []);
    // const fetchtAgentsBySupervisor = () => {
        // getAgentsBySupervisor(supervisor.document_id);
    //     console.log(supervisor.document_id)
    // }
