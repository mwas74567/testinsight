...
const AddTerritoryDialog = ({ addTerritory, clearErrors, classes, UI, territories, loading }) => {
    ...
    //when loading changes without errors, a request to the backend was successful
    React.useEffect(() => {
        if(
            !loading &&
            UI.errors &&
